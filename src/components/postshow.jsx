...
function Postshow() {
  ...
  return (
    <>
            <div className='bg-green-800 py-8 px-12 flex justify-between rounded-full items-center'>
                <h2 className="text-4xl font-bold text-white">Product List</h2>
                <button
                    className='px-6 py-2 bg-black font-bold text-white rounded-lg hover:bg-gray-300 shadow-md'
            ...
            <div className="mx-6 my-8">
                {
                    ...
                    <div className="flex flex-wrap gap-6 items-center justify-center p-6">
                        {productShow.map(product => (
                            <div
                                key={product.id}
                                className="flex flex-col items-center border-4 border-green-800 rounded-lg shadow-lg bg-white max-w-[365px] w-full p-4">
                                ...
                                <p className="text-gray-600 text-sm mb-2">Condition : {product.description}</p>
